...
(function (states) {
    ...
    var Level2 = (function (_super) {
        ...
        Level2.prototype.start = function () {
            ...
            scoreBoard = new managers.ScoreBoard(100, 1000, 2);
            // mapString
            mapString = new Array();
            mapString = [
                " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ",
            ...
            // nextbutton
            this._nextButton = new objects.Button("next_button", 320, 240, null, null, true);
        ...
        Level2.prototype._clickExitButton = function (event) {
            window.close();
        };
        Level2.prototype._clickNextButton = function (event) {
            this._loadGame(config.STATE_LEVEL3);
        };
        Level2.prototype._clickPlayAgainButton = function (event) {
            this._loadGame(config.STATE_LEVEL2);
        };
        Level2.prototype._loadGame = function (level) {
            state = level;
            changeState(state);
        };
